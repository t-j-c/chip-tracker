...
export class ChipTrackerStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ChipTrackerStackProps) {
    ...
    // CloudFront Distribution: S3 (default, static assets) + ALB (/api/*, /hubs/*)
    ...
    backendTaskDefinition.addContainer('backend', {
      image: ecs.ContainerImage.fromEcrRepository(this.ecrBackend, imageTag),
      ...
      environment: {
        ...
        'DynamoDB__TableName': gameRoomsTable.tableName,
        'Cors__AllowedOrigins__0': `https://${distribution.distributionDomainName}`,
      },
      portMappings: [
        {
          containerPort: 5000,
    ...
    new cdk.CfnOutput(this, 'CloudFrontDistributionId', {
      ...
      exportName: `${projectName}-cf-distribution-id`,
    });

    new cdk.CfnOutput(this, 'FrontendBucketName', {
      value: frontendBucket.bucketName,
      description: 'Frontend S3 Bucket Name',
      exportName: `${projectName}-frontend-bucket`,
    });
